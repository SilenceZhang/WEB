...
public class GetMyInfo {
	...
	public static void main(String[] args) throws ClassNotFoundException, SecurityException, NoSuchMethodException,
		...
		Class mclass = Class.forName("com.test.spring.UserInfo");
		...
		for (Method method : methods) {
			...
			System.out.print(
					Modifier.toString(methodFangWen) + " " + methodRetrunType.getSimpleName() + " " + methodName + "(");
		...
		for (Constructor constructor : constructors) {
			...
			System.out.print(mclass.getSimpleName() + " "
					+ constructorName.substring(constructorName.lastIndexOf(".") + 1, constructorName.length()) + "(");
